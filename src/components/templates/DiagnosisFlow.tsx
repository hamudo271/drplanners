...
export function DiagnosisFlow() {
  const [step, setStep] = useState(0); // 0 = 인트로, 1..5 = 문항, 6 = 정보 입력
        ...
        <div className="mx-auto max-w-[680px] border border-ink-900/15 bg-cream-100 p-8 md:p-12">
          ...
          {isIntro && !done && (
            <div className="text-center">
              ...
              <p className="label label-ko mt-8">3분이면 충분합니다 · 비용 없음</p>
              <button type="button" onClick={() => setStep(1)} className="mt-6">
          ...
          {/* ── 병원 정보 입력 ── */}
          {!done && isForm && (
            <form id="form" action={action} noValidate>
