...
export const CTA = {
  ...
  second: "병원 진단 시작하기",
  /** 문의 버튼 앞에서 망설이지 않도록, 누른 뒤 실제로 벌어지는 일 */
  stepsLabel: "문의하시면",
  steps: [
    {
      title: "문의 남기기",
      body: "병원 상황과 궁금한 점만 적어주시면 됩니다. 3분이면 충분합니다.",
    },
    {
      title: "담당 플래너 검토",
    ...
    {
      title: "맞춤 제안",
      body: "진단 결과를 바탕으로 무엇부터 할지 순서를 정해 제안드립니다.",
    },
  ],
  note: "월 4개 병원만 새로 맡습니다 · 진단과 상담에는 비용이 없습니다",
};
